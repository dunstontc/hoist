...
if stringContains 'el6' "$(uname -a)";     then OS_NAME="centos";  fi
if stringContains 'el7' "$(uname -a)";     then OS_NAME="centos";  fi
if stringContains 'fc26' "$(uname -a)";    then OS_NAME="fedora";  fi
if stringContains 'fc27' "$(uname -a)";    then OS_NAME="fedora";  fi
if stringContains 'fc28' "$(uname -a)";    then OS_NAME="fedora";  fi
